...
<body class="antialiased">
    ...
    <div class="min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
        <div class="flex flex-col items-center justify-center min-h-screen mx-auto max-w-7xl">
            <x-application-mark class="mb-6" />

            @if (Route::has('login'))
            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10 text-4xl mt-10">
                @auth
